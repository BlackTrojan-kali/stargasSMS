        ...
        <nav class="mt-2 p-2 w-full text-white flex flex-col md:flex-row gap-4   bg-teal-700 rounded-md">
            ...
            <div class="drop-items">
                ...
                <div class="drop-2 elem">
                    MOUVEMENTS Sortie
                    <ul class="drop-items-2">
                        <li class="elem" ><a href="{{ route("moveEntryPro",["state"=>1,"type"=>0,"weight"=>6]) }}">6 KG (sortie)</a></li>
                        <li class="elem" ><a href="{{ route("moveEntryPro",["state"=>1,"type"=>0,"weight"=>12.5]) }}">12.5 KG (sortie)</a></li>
                        <li class="elem"><a href="{{ route("moveEntryPro",["state"=>1,"type"=>0,"weight"=>50]) }}">50 KG (sortie)</a></li>
                        <li class="elem" ><a href="{{ route("moveEntryPro",["state"=>1,"type"=>0,"weight"=>0]) }}">ACCESSOIRES (sortie)</a></li>
                    </ul>
                </div>
                ...
                <div class="drop-2 elem">
                    MOUVEMENTS Global
                    <ul class="drop-items-2">
                        <li class="elem"><a  href="{{ route("moveGlobalPro",["type"=>"bouteille-gaz","weight"=>6]) }}">6 KG (global)</a></li>
                        <li class="elem" ><a href="{{ route("moveGlobalPro",["type"=>"bouteille-gaz","weight"=>12.5]) }}">12.5 KG (global)</a></li>
                        <li class="elem"><a href="{{ route("moveGlobalPro",["type"=>"bouteille-gaz","weight"=>50]) }}">50 KG (global)</a></li>
                    </ul>
                </div>
            </div>
            </div>
