            ...
            <div class="dropdown cursor-pointer font-bold relative">    ETATS <i class="fa-solid fa-angle-down"></i>
                <div class="drop-items">
                    <div class="drop-2 elem">
                        MOUVEMENTS ENTREES
                        <ul class="drop-items-2">
                            <li class="elem" ><a href="{{ route("moveEntryMan",["state"=>1,"type"=>1,"weight"=>6]) }}">6 KG</a></li>
                            <li class="elem" ><a href="{{ route("moveEntryMan",["state"=>1,"type"=>1,"weight"=>12.5]) }}">12.5 KG</a></li>
                            <li class="elem"><a href="{{ route("moveEntryMan",["state"=>1,"type"=>1,"weight"=>50]) }}">  50 KG</a></li>
                            <li class="elem" ><a href="{{ route("moveEntryMan",["state"=>1,"type"=>1,"weight"=>0]) }}">ACCESSOIRES</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="drop-2 elem">
                        MOUVEMENTS Sortie
                        <ul class="drop-items-2">
                            <li class="elem"><a href="{{ route("moveEntryMan",["state"=>1,"type"=>0,"weight"=>6]) }}">6 KG (sortie)</a></li>
                            <li class="elem"><a href="{{ route("moveEntryMan",["state"=>1,"type"=>0,"weight"=>12.5]) }}">12.5 KG (sortie)</a></li>
                            <li class="elem"><a href="{{ route("moveEntryMan",["state"=>1,"type"=>0,"weight"=>50]) }}">50 KG (sortie)</a></li>
                            <li class="elem"><a href="{{ route("moveEntryMan",["state"=>1,"type"=>0,"weight"=>0]) }}">ACCESSOIRES (sortie)</a></li>
                    ...
                    <div class="drop-2 elem">
                        MOUVEMENTS Global
                        <ul class="drop-items-2">
                            <li class="elem"><a  href="{{ route("moveGlobalMan",["type"=>"bouteille-gaz","weight"=>6]) }}">6 KG (global)</a></li>
                            <li class="elem"><a href="{{ route("moveGlobalMan",["type"=>"bouteille-gaz","weight"=>12.5]) }}">12.5 KG (global)</a></li>
                            <li class="elem"><a href="{{ route("moveGlobalMan",["type"=>"bouteille-gaz","weight"=>50]) }}">50 KG (global)</a></li>
                            <li class="elem" ><a href="{{ route("moveGlobalMan",["type"=>"accessoire","weight"=>0]) }}">ACCESSOIRES (global)</a></li>
                        
                        </ul>
                    </div>
                    <div class="text-center elem"><a href="{{ route("historique-rel") }}">Etats depotages</a></div>
                </div>
                </div>
            ...
            <form id="entry-pleine-form"  >
                ...
                <div class="modal-champs">
                    ...
                    <select name="origin" id="">
                        ...
                        <option value="production">production</option>
                        <option value="production">retour sur vente</option>
    ...
    <center>
        ...
        <div class="modal-active">
            ...
            <form id="outcome-gpl-form"  >
                ...
                <div class="modal-champs">
                    <label for="">Quantite  <span class="text-red-500">*</span></label> <div>
                    <input type="number" name="qty" required>
