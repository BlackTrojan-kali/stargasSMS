...
<body class="px-30">
    ...
    <header class="p-4 text-sm  md:text-base ">
       ...
       <nav class="mt-2 p-2 w-full text-white flex flex-col md:flex-row gap-4   bg-teal-700 rounded-md">
        <a href="{{route("dashboardCom")}}"><i class="fa-solid fa-home"></i> ACCEUIL</a>
        @if(Auth::user()->region != "centre" && Auth::user()->role != "controller")
            ...
            <div class="dropdown cursor-pointer font-bold">    ETATS <i class="fa-solid fa-angle-down"></i>
                <div class="drop-items">
                    <div class="drop-2 elem">
                        MOUVEMENTS ENTREES
                        <ul class="drop-items-2">
                            <li class="elem" id="activate-form-entry-vide"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>1,"weight"=>6]) }}">6 KG</a></li>
                            <li class="elem" id="activate-form-entry-gpl"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>1,"weight"=>12.5]) }}">12.5 KG</a></li>
                            <li class="elem" id="activate-form-entry-accessory"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>1,"weight"=>50]) }}">  50 KG</a></li>
                            <li class="elem" id="activate-form-entry-vide"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>1,"weight"=>0]) }}">ACCESSOIRES</a></li>
                    ...
                    <div class="drop-2 elem">
                        MOUVEMENTS Sortie
                        <ul class="drop-items-2">
                            <li class="elem" id="activate-form-entry-vide"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>0,"weight"=>6]) }}">6 KG (sortie)</a></li>
                            <li class="elem" id="activate-form-entry-gpl"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>0,"weight"=>12.5]) }}">12.5 KG (sortie)</a></li>
                            <li class="elem" id="activate-form-entry-accessory"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>0,"weight"=>50]) }}">50 KG (sortie)</a></li>
                            <li class="elem" id="activate-form-entry-vide"><a href="{{ route("moveEntryCom",["state"=>1,"type"=>0,"weight"=>0]) }}">ACCESSOIRES (sortie)</a></li>
                    ...
                    <div class="drop-2 elem">
                        MOUVEMENTS Global
                        <ul class="drop-items-2">
                            <li class="elem" ><a  href="{{ route("moveGlobalCom",["type"=>"bouteille-gaz","weight"=>6]) }}">6 KG (global)</a></li>
                            <li class="elem" ><a href="{{ route("moveGlobalCom",["type"=>"bouteille-gaz","weight"=>12.5]) }}">12.5 KG (global)</a></li>
                            <li class="elem" ><a href="{{ route("moveGlobalCom",["type"=>"bouteille-gaz","weight"=>50]) }}">50 KG (global)</a></li>
                            <li class="elem" ><a href="{{ route("moveGlobalCom",["type"=>"accessoire","weight"=>0]) }}">ACCESSOIRES (global)</a></li>
     ...
     <div id="acSales-form" class="modals">
         <center>
          ...
          <div class="modal-active w-full md-6/12">
              ...
              <b class="success text-green-500"></b>
              <b class="errors text-red-500"></b>
              <form id="sale-gpl-for" action="{{ route("makeAcSales",['type'=>"accessoire"]) }}" method="POST" >
              @csrf
